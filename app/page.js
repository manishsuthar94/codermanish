  ...
  return (
    <main className='mb-20'>
      ...
      <div className="text-center mb-0 mt-8">
        <h1 className="text-4xl font-bold pb-2">Skills<span className="text-primary">.</span></h1>
      ...
      <div className='grid place-content-center mt-2 mb-10 pb-9'>
        <Button asChild variant="secondary"><Link href="/skills">View All Skills</Link></Button>
      </div>
      
      <div className="text-center mb-5">
        <h1 className="text-4xl font-bold pb-3">Projects<span className="text-primary">.</span></h1>
        <p className='text-xs pb-3'>Some of my projects i built, click view all <br /> for all projects<span className="text-primary">.</span></p>
      </div>
