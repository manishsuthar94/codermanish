        ...
        <header className="flex justify-between items-center py-5 px-7 md:px-20 lg:px-32">
            ...
            <div className="flex gap-3 items-center justify-center">
                <ul className="md:flex gap-4 text-sm mr-5 hidden">
                    <li className="hover:underline underline-offset-4 hover:text-primary"><Link href="/">Home</Link></li>
                    ...
                    <li className="hover:underline underline-offset-4 hover:text-primary"><Link href="/about">About</Link></li>
                </ul>
